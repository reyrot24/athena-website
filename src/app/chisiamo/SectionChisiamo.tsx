...
async function SectionChisiamo(props: Blog41Props) {
  ...
  return (
    <section className="mb-20">
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-4 container">
        {chisiamo.map((persona, i) => (
          <div key={i}>
            <div className="mb-6 inline-block w-full max-w-full focus-visible:outline-none">
              <div className="w-full overflow-hidden h-72">
                <Image
                  ...
                  alt={persona.nome}
                  className="  size-full object-cover border border-accentYellow"
                  width={0}
                  height={0}
                  sizes="100vw"
                />
            ...
            <h5 className="text-2xl font-bold md:text-3xl mb-2 block max-w-full focus-visible:outline-none">
              {persona.nome}
            </h5>
