...
const buttonVariants = cva(
  "inline-flex items-center  justify-center whitespace-nowrap rounded-md text-xl font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-bg text-text rounded-xl border border-accentYellow hover:bg-accent",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-text rounded-3xl bg-accentYellow text-text hover:bg-accent/90 hover:text-accent-foreground/90",
        toggle:
          "border border-accentYellow rounded-3xl bg-bg text-text hover:bg-accent/90 ",
        secondary:
